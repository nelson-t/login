 ...
 */
public class ResourcesUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("_Resources_Maintenance");
        setToolTipText("");
        ...
        tblMain.setModel(resourceService.getTableModel(null));
        ...
        lId.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        lId.setText("_Id");
        ...
        recordTabs.addTab("_Resource_information", tabGeneralInfo);
        ...
        lAvailableRoles.setText("_Available_actions");

        lUserRoles.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        lUserRoles.setText("_Resource's_actions");
        ...
        recordTabs.addTab("_Resource_actions", tabRoles);
    ...
    private void tCommentsKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tCommentsKeyPressed
        if (tComments.getText().length() >= MAX_RESOURCE_COMMENTS){
            JOptionPane.showMessageDialog(this, UIUtils.getLocalText("msg._Max._length_exceeded!")+"  "+MAX_RESOURCE_COMMENTS);
            tComments.setText(tComments.getText().substring(0, MAX_RESOURCE_COMMENTS-1));
        }
    ...
    private void tNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tNameKeyPressed
        if (tName.getText().length() >= MAX_RESOURCE_NAME){
            JOptionPane.showMessageDialog(this, UIUtils.getLocalText("msg._Max._length_exceeded!")+"  "+MAX_RESOURCE_NAME);
            tName.setText(tName.getText().substring(0, MAX_RESOURCE_NAME-1));
        }
    ...
    private void myInitComponents() {
        setTitle(UIUtils.getLocalText("title._Resources_Maintenance"));
  ...
  private void createRecord() {
        boolean success=ResourceService.getInstance().addResource(tName.getText(), tComments.getText(),
                        cbEnabled.isSelected(), UIUtils.jListToArrayList(listRight));
        if (success) {
            tId.setText("" + ResourceService.getInstance().getResource(tName.getText()).getId());
            tSearch.setText("");
            reloadTable();
        }
    }    
    ...
    private void reloadTable() {
        ...
        if(tSearch.getText().equals(UIUtils.getLocalText("msg._Enter_Text")))
            sText="";
        tblMain.setModel(resourceService.getTableModel(sText));
        setTableConfiguration();
        tblMain.repaint();
    }
    ...
    private void saveRecord() {
        resourceService.updateResource(Integer.parseInt(tId.getText()), tName.getText(), tComments.getText(),
                        cbEnabled.isSelected(), UIUtils.jListToArrayList(listRight));
    ...
    private void deleteRecord() {
        ...
        if (opc == 0) {
            if (resourceService.deleteResource(Integer.parseInt(tId.getText()))) {
                JOptionPane.showMessageDialog(this, UIUtils.getLocalText("msg._Operation_successful!"));
    ...
    void setActionLists() {
        String arr[] = ResourceService.getInstance().getResourceActionList(Integer.parseInt(tId.getText()));
        listRight.setListData(arr);
        listLeft.setListData(ResourceService.getInstance().getResourceAvailableNewActions(arr));        
    }
}
