...
public class ActionsUI extends javax.swing.JInternalFrame {
    ...
    private void myInitComponents() {
        setTitle(UIUtils.getLocalText("title._Actions_Maintenance"));
  ...
  private void createRecord() {
        Utils.print("Create Action Record...");
        boolean success = ActionService.getInstance().addAction(tName.getText(), tComments.getText(), cbEnabled.isSelected());
        if (success) {
    ...
    private void saveRecord() {
        actionService.updateAction(Integer.parseInt(tId.getText()), tName.getText(), tComments.getText(), cbEnabled.isSelected());
