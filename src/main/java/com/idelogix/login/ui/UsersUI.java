...
public class UsersUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(tabGeneralInfoLayout.createSequentialGroup()
                ...
                .addGroup(tabGeneralInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(tabGeneralInfoLayout.createSequentialGroup()
                        ...
                        .addGroup(tabGeneralInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(tabGeneralInfoLayout.createSequentialGroup()
                                .addComponent(tUserid, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        recordTabs.addTab("_General_information", tabGeneralInfo);
    ...
    private void myInitComponents() {
        setTitle(UIUtils.getLocalText("title._Users_Maintenance"));
  ...
  private void createRecord() {
        ...
        try {
            success = UserService.getInstance().createUser(Integer.parseInt(tUserid.getText()), tName.getText(), tComments.getText(),
                      cbEnabled.isSelected(), new SimpleDateFormat(dateFormat).parse(tDateCreated.getText()),  
                      new String(tPassword.getPassword()), UIUtils.jListToArrayList(listRight));
